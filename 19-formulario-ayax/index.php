...
<nav class="navbar navbar-dark bg-primary">
  ...
  <div class="col-lg-6 col-md-6 col-sm-12">
   <form method="POST" id="formulario" action="proceso.php">
  ...
  <div class="form-group">
  <label for="#" name="ocupacion">Ocupación</label>
  ...
  <div class="form-check">
    <input type="radio" name="sexo" class="form-check-input" id="exampleCheck1" value="option1">
    <label class="form-check-label" for="exampleCheck1">Hombre</label>
  </div>
  <div class="form-check">
    <input type="radio" name="sexo" class="form-check-input" id="exampleCheck2" value="option2">
